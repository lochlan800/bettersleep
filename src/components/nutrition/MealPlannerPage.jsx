...
const FOOD_DATABASE = [
  ...
  // ── Nuts & Seeds ──
  { name: 'Peanut butter', groups: ['Protein'], nutrients: { carbs: 20, protein: 25, fat: 50, fibre: 6, iron: 1.9, calcium: 43, vitC: 0, sugar: 9 } },
  { name: 'Almond butter', groups: ['Protein'], nutrients: { carbs: 19, protein: 21, fat: 56, fibre: 10, iron: 3.5, calcium: 347, vitC: 0, sugar: 5 } },
  { name: 'Peanuts', groups: ['Protein'], nutrients: { carbs: 16, protein: 26, fat: 49, fibre: 9, iron: 4.6, calcium: 92, vitC: 0, sugar: 4 } },
  { name: 'Almonds', groups: ['Protein'], nutrients: { carbs: 22, protein: 21, fat: 50, fibre: 13, iron: 3.7, calcium: 264, vitC: 0, sugar: 4 } },
  { name: 'Walnuts', groups: ['Protein'], nutrients: { carbs: 14, protein: 15, fat: 65, fibre: 7, iron: 2.9, calcium: 98, vitC: 1, sugar: 3 } },
  { name: 'Cashews', groups: ['Protein'], nutrients: { carbs: 30, protein: 18, fat: 44, fibre: 3, iron: 6.7, calcium: 37, vitC: 0, sugar: 6 } },
  { name: 'Pistachios', groups: ['Protein'], nutrients: { carbs: 28, protein: 20, fat: 45, fibre: 10, iron: 3.9, calcium: 105, vitC: 5, sugar: 8 } },
  { name: 'Hazelnuts', groups: ['Protein'], nutrients: { carbs: 17, protein: 15, fat: 61, fibre: 10, iron: 4.7, calcium: 114, vitC: 6, sugar: 4 } },
  { name: 'Brazil nuts', groups: ['Protein'], nutrients: { carbs: 12, protein: 14, fat: 66, fibre: 8, iron: 2.4, calcium: 160, vitC: 1, sugar: 2 } },
  { name: 'Pecans', groups: ['Protein'], nutrients: { carbs: 14, protein: 9, fat: 72, fibre: 10, iron: 2.5, calcium: 70, vitC: 1, sugar: 4 } },
  { name: 'Macadamia nuts', groups: ['Protein'], nutrients: { carbs: 14, protein: 8, fat: 76, fibre: 9, iron: 3.7, calcium: 85, vitC: 1, sugar: 4 } },
  { name: 'Pine nuts', groups: ['Protein'], nutrients: { carbs: 13, protein: 14, fat: 68, fibre: 4, iron: 5.5, calcium: 16, vitC: 1, sugar: 4 } },
  { name: 'Pumpkin seeds', groups: ['Protein'], nutrients: { carbs: 11, protein: 30, fat: 49, fibre: 6, iron: 8.8, calcium: 46, vitC: 2, sugar: 1 } },
  { name: 'Sunflower seeds', groups: ['Protein'], nutrients: { carbs: 20, protein: 21, fat: 51, fibre: 9, iron: 5.3, calcium: 78, vitC: 1, sugar: 3 } },
  { name: 'Chia seeds', groups: ['Protein'], nutrients: { carbs: 42, protein: 17, fat: 31, fibre: 34, iron: 7.7, calcium: 631, vitC: 2, sugar: 0 } },
  { name: 'Flaxseeds', groups: ['Protein'], nutrients: { carbs: 29, protein: 18, fat: 42, fibre: 27, iron: 5.7, calcium: 255, vitC: 1, sugar: 2 } },
  { name: 'Sesame seeds', groups: ['Protein'], nutrients: { carbs: 23, protein: 18, fat: 50, fibre: 12, iron: 14.6, calcium: 975, vitC: 0, sugar: 0 } },
  { name: 'Hemp seeds', groups: ['Protein'], nutrients: { carbs: 9, protein: 32, fat: 49, fibre: 4, iron: 8.0, calcium: 70, vitC: 1, sugar: 2 } },
  { name: 'Poppy seeds', groups: ['Protein'], nutrients: { carbs: 28, protein: 18, fat: 42, fibre: 20, iron: 9.8, calcium: 1438, vitC: 1, sugar: 3 } },
  { name: 'Mixed nuts', groups: ['Protein'], nutrients: { carbs: 18, protein: 20, fat: 54, fibre: 7, iron: 3.7, calcium: 110, vitC: 1, sugar: 4 } },
  { name: 'Mixed seeds', groups: ['Protein'], nutrients: { carbs: 20, protein: 24, fat: 45, fibre: 12, iron: 8.0, calcium: 320, vitC: 1, sugar: 2 } },
  { name: 'Coconut (desiccated)', groups: ['Protein'], nutrients: { carbs: 24, protein: 7, fat: 65, fibre: 16, iron: 3.3, calcium: 26, vitC: 1, sugar: 7 } },
  // ── Legumes ──
  ...
  { name: 'Chocolate', groups: [], nutrients: { carbs: 59, protein: 8, fat: 30, fibre: 3, iron: 2.4, calcium: 189, vitC: 0, sugar: 52 }, unhealthy: true },
  { name: 'Dark chocolate', groups: [], nutrients: { carbs: 46, protein: 8, fat: 43, fibre: 11, iron: 12.0, calcium: 73, vitC: 0, sugar: 24 }, unhealthy: true },
  { name: 'Crisps', groups: [], nutrients: { carbs: 15, protein: 2, fat: 10, fibre: 1, iron: 0.3, calcium: 5, vitC: 3, sugar: 1 }, unhealthy: true },
  { name: 'Biscuits', groups: ['Grains'], nutrients: { carbs: 68, protein: 6, fat: 21, fibre: 3, iron: 2.0, calcium: 90, vitC: 0, sugar: 22 }, unhealthy: true },
  ...
  { name: 'Brownie', groups: ['Grains'], nutrients: { carbs: 55, protein: 6, fat: 26, fibre: 2, iron: 2.5, calcium: 40, vitC: 0, sugar: 40 }, unhealthy: true },
  ...
  { name: 'Fruit snack', groups: ['Fruit'], nutrients: { carbs: 78, protein: 0, fat: 1, fibre: 1, iron: 0.5, calcium: 10, vitC: 20, sugar: 60 } },
  { name: 'Jelly/jello', groups: [], nutrients: { carbs: 15, protein: 1, fat: 0, fibre: 0, iron: 0, calcium: 2, vitC: 0, sugar: 12 }, unhealthy: true },
  { name: 'Sweets/candy', groups: [], nutrients: { carbs: 85, protein: 0, fat: 0, fibre: 0, iron: 0.3, calcium: 5, vitC: 0, sugar: 70 }, unhealthy: true },
  // ── Drinks ──
  ...
  // ── Condiments & extras ──
  { name: 'Honey', groups: [], nutrients: { carbs: 82, protein: 0.3, fat: 0, fibre: 0.2, iron: 0.4, calcium: 6, vitC: 0.5, sugar: 82 }, unhealthy: true },
  { name: 'Jam', groups: [], nutrients: { carbs: 65, protein: 0.4, fat: 0, fibre: 1, iron: 0.2, calcium: 20, vitC: 3, sugar: 60 }, unhealthy: true },
  { name: 'Nutella', groups: [], nutrients: { carbs: 57, protein: 6, fat: 31, fibre: 3, iron: 4.0, calcium: 108, vitC: 0, sugar: 56 }, unhealthy: true },
  { name: 'Maple syrup', groups: [], nutrients: { carbs: 67, protein: 0, fat: 0, fibre: 0, iron: 0.1, calcium: 102, vitC: 0, sugar: 60 }, unhealthy: true },
  ...
  { name: 'Ketchup', groups: [], nutrients: { carbs: 26, protein: 1, fat: 0, fibre: 0.3, iron: 0.4, calcium: 15, vitC: 4, sugar: 22 }, unhealthy: true },
  ...
  { name: 'Tahini', groups: ['Protein'], nutrients: { carbs: 21, protein: 17, fat: 54, fibre: 9, iron: 8.9, calcium: 426, vitC: 0, sugar: 0 } },
  // ── Supplements ──
