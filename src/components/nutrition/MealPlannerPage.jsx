...
const FOOD_DATABASE = [
  ...
  { name: 'Bacon', groups: ['Protein'], nutrients: { carbs: 0, protein: 12, fat: 14, fibre: 0, iron: 0.4, calcium: 5, vitC: 0 }, unhealthy: true },
  ...
  { name: 'Cream', groups: ['Dairy'], nutrients: { carbs: 3, protein: 2, fat: 37, fibre: 0, iron: 0, calcium: 65, vitC: 1 }, unhealthy: true },
  { name: 'Ice cream', groups: ['Dairy'], nutrients: { carbs: 24, protein: 4, fat: 11, fibre: 0, iron: 0.1, calcium: 130, vitC: 1 }, unhealthy: true },
  // ── Grains & Carbs ──
  ...
  { name: 'Croissant', groups: ['Grains', 'Dairy'], nutrients: { carbs: 26, protein: 5, fat: 12, fibre: 1, iron: 1.0, calcium: 20, vitC: 0 }, unhealthy: true },
  ...
  { name: 'Weetabix Minis (chocolate)', groups: ['Grains'], nutrients: { carbs: 36, protein: 4, fat: 3, fibre: 3, iron: 4.0, calcium: 20, vitC: 0 }, unhealthy: true },
  { name: 'Weetabix Protein', groups: ['Grains', 'Protein'], nutrients: { carbs: 28, protein: 8, fat: 2, fibre: 4, iron: 5.0, calcium: 25, vitC: 0 } },
  ...
  { name: 'Crunchy Nut Cornflakes', groups: ['Grains'], nutrients: { carbs: 38, protein: 3, fat: 2, fibre: 1, iron: 4.2, calcium: 5, vitC: 0 }, unhealthy: true },
  { name: 'Cornflakes', groups: ['Grains'], nutrients: { carbs: 36, protein: 3, fat: 0, fibre: 1, iron: 4.0, calcium: 4, vitC: 0 } },
  { name: 'Coco Pops', groups: ['Grains'], nutrients: { carbs: 38, protein: 2, fat: 1, fibre: 1, iron: 4.5, calcium: 10, vitC: 0 }, unhealthy: true },
  { name: 'Rice Krispies', groups: ['Grains'], nutrients: { carbs: 37, protein: 3, fat: 0, fibre: 0, iron: 4.0, calcium: 4, vitC: 0 } },
  { name: 'Frosties', groups: ['Grains'], nutrients: { carbs: 39, protein: 2, fat: 0, fibre: 1, iron: 4.0, calcium: 3, vitC: 0 }, unhealthy: true },
  { name: 'Cheerios', groups: ['Grains'], nutrients: { carbs: 32, protein: 4, fat: 2, fibre: 3, iron: 5.0, calcium: 130, vitC: 0 } },
  { name: 'Honey Cheerios', groups: ['Grains'], nutrients: { carbs: 35, protein: 3, fat: 2, fibre: 3, iron: 5.0, calcium: 130, vitC: 0 }, unhealthy: true },
  { name: 'Shreddies', groups: ['Grains'], nutrients: { carbs: 33, protein: 4, fat: 1, fibre: 5, iron: 4.5, calcium: 20, vitC: 0 } },
  { name: 'Coco Shreddies', groups: ['Grains'], nutrients: { carbs: 35, protein: 3, fat: 2, fibre: 4, iron: 4.5, calcium: 20, vitC: 0 }, unhealthy: true },
  { name: 'Frosted Shreddies', groups: ['Grains'], nutrients: { carbs: 36, protein: 3, fat: 1, fibre: 4, iron: 4.5, calcium: 20, vitC: 0 }, unhealthy: true },
  { name: 'Special K', groups: ['Grains'], nutrients: { carbs: 33, protein: 5, fat: 1, fibre: 1, iron: 5.6, calcium: 20, vitC: 0 } },
  { name: 'Special K Protein', groups: ['Grains', 'Protein'], nutrients: { carbs: 28, protein: 10, fat: 2, fibre: 3, iron: 5.0, calcium: 25, vitC: 0 } },
  { name: 'Bran Flakes', groups: ['Grains'], nutrients: { carbs: 30, protein: 4, fat: 1, fibre: 6, iron: 6.0, calcium: 20, vitC: 0 } },
  { name: 'All-Bran', groups: ['Grains'], nutrients: { carbs: 24, protein: 6, fat: 2, fibre: 11, iron: 5.0, calcium: 25, vitC: 0 } },
  { name: 'Fruit & Fibre', groups: ['Grains', 'Fruit'], nutrients: { carbs: 32, protein: 3, fat: 3, fibre: 4, iron: 4.5, calcium: 15, vitC: 0 } },
  { name: 'Crunchy Nut Clusters', groups: ['Grains'], nutrients: { carbs: 34, protein: 4, fat: 6, fibre: 2, iron: 3.5, calcium: 10, vitC: 0 }, unhealthy: true },
  { name: 'Cookie Crisp', groups: ['Grains'], nutrients: { carbs: 38, protein: 2, fat: 3, fibre: 2, iron: 4.0, calcium: 130, vitC: 0 }, unhealthy: true },
  { name: 'Golden Nuggets', groups: ['Grains'], nutrients: { carbs: 38, protein: 2, fat: 1, fibre: 1, iron: 4.0, calcium: 5, vitC: 0 }, unhealthy: true },
  { name: 'Sugar Puffs / Honey Monster Puffs', groups: ['Grains'], nutrients: { carbs: 37, protein: 3, fat: 1, fibre: 2, iron: 4.0, calcium: 10, vitC: 0 }, unhealthy: true },
  { name: 'Raisin Bran', groups: ['Grains', 'Fruit'], nutrients: { carbs: 35, protein: 3, fat: 1, fibre: 5, iron: 5.0, calcium: 20, vitC: 0 } },
  { name: 'Lucky Charms', groups: ['Grains'], nutrients: { carbs: 37, protein: 2, fat: 1, fibre: 1, iron: 4.5, calcium: 130, vitC: 0 }, unhealthy: true },
  { name: 'Curiously Cinnamon', groups: ['Grains'], nutrients: { carbs: 36, protein: 2, fat: 4, fibre: 2, iron: 4.0, calcium: 130, vitC: 0 }, unhealthy: true },
  { name: 'Krave', groups: ['Grains'], nutrients: { carbs: 33, protein: 3, fat: 6, fibre: 2, iron: 4.5, calcium: 130, vitC: 0 }, unhealthy: true },
  { name: 'Lion Cereal', groups: ['Grains'], nutrients: { carbs: 37, protein: 2, fat: 3, fibre: 2, iron: 4.5, calcium: 130, vitC: 0 }, unhealthy: true },
  { name: 'Nesquik Cereal', groups: ['Grains'], nutrients: { carbs: 37, protein: 2, fat: 2, fibre: 2, iron: 4.5, calcium: 130, vitC: 0 }, unhealthy: true },
  { name: 'Frosted Flakes', groups: ['Grains'], nutrients: { carbs: 39, protein: 2, fat: 0, fibre: 1, iron: 4.0, calcium: 3, vitC: 0 }, unhealthy: true },
  { name: 'Corn Chex', groups: ['Grains'], nutrients: { carbs: 37, protein: 2, fat: 0, fibre: 1, iron: 6.0, calcium: 100, vitC: 0 } },
  { name: 'Grape Nuts', groups: ['Grains'], nutrients: { carbs: 32, protein: 4, fat: 1, fibre: 3, iron: 5.0, calcium: 15, vitC: 0 } },
  { name: 'Shredded Wheat', groups: ['Grains'], nutrients: { carbs: 31, protein: 5, fat: 1, fibre: 5, iron: 1.5, calcium: 15, vitC: 0 } },
  { name: 'Shredded Wheat Bitesize', groups: ['Grains'], nutrients: { carbs: 31, protein: 5, fat: 1, fibre: 5, iron: 1.5, calcium: 15, vitC: 0 } },
  { name: 'Harvest Morn / Aldi Granola', groups: ['Grains'], nutrients: { carbs: 28, protein: 4, fat: 7, fibre: 3, iron: 1.5, calcium: 20, vitC: 0 } },
  { name: 'Alpen', groups: ['Grains'], nutrients: { carbs: 30, protein: 4, fat: 3, fibre: 3, iron: 2.5, calcium: 30, vitC: 0 } },
  { name: 'Alpen No Added Sugar', groups: ['Grains'], nutrients: { carbs: 28, protein: 5, fat: 4, fibre: 4, iron: 2.5, calcium: 30, vitC: 0 } },
  { name: 'Jordan\'s Country Crisp', groups: ['Grains'], nutrients: { carbs: 29, protein: 4, fat: 8, fibre: 3, iron: 1.5, calcium: 20, vitC: 0 } },
  { name: 'Dorset Cereals Muesli', groups: ['Grains'], nutrients: { carbs: 28, protein: 5, fat: 4, fibre: 4, iron: 2.0, calcium: 30, vitC: 0 } },
  { name: 'Puffed Wheat', groups: ['Grains'], nutrients: { carbs: 31, protein: 6, fat: 1, fibre: 3, iron: 1.5, calcium: 10, vitC: 0 } },
  { name: 'Puffed Rice', groups: ['Grains'], nutrients: { carbs: 37, protein: 3, fat: 0, fibre: 0, iron: 0.5, calcium: 5, vitC: 0 } },
  { name: 'Choco Pillows', groups: ['Grains'], nutrients: { carbs: 35, protein: 3, fat: 5, fibre: 2, iron: 4.0, calcium: 15, vitC: 0 }, unhealthy: true },
  { name: 'Weetos', groups: ['Grains'], nutrients: { carbs: 35, protein: 3, fat: 2, fibre: 3, iron: 4.5, calcium: 20, vitC: 0 }, unhealthy: true },
  { name: 'Ready Brek', groups: ['Grains'], nutrients: { carbs: 27, protein: 5, fat: 4, fibre: 4, iron: 4.5, calcium: 20, vitC: 0 } },
  { name: 'Overnight oats', groups: ['Grains', 'Dairy'], nutrients: { carbs: 22, protein: 6, fat: 5, fibre: 4, iron: 1.5, calcium: 100, vitC: 0 } },
  { name: 'Instant oat sachets', groups: ['Grains'], nutrients: { carbs: 30, protein: 4, fat: 3, fibre: 3, iron: 3.5, calcium: 15, vitC: 0 } },
  { name: 'Granola (chocolate)', groups: ['Grains'], nutrients: { carbs: 30, protein: 4, fat: 9, fibre: 3, iron: 1.5, calcium: 25, vitC: 0 }, unhealthy: true },
  { name: 'Granola (nut)', groups: ['Grains', 'Protein'], nutrients: { carbs: 26, protein: 5, fat: 10, fibre: 3, iron: 1.5, calcium: 30, vitC: 0 } },
  { name: 'Granola (berry)', groups: ['Grains', 'Fruit'], nutrients: { carbs: 29, protein: 4, fat: 7, fibre: 3, iron: 1.5, calcium: 20, vitC: 1 } },
  { name: 'Protein granola', groups: ['Grains', 'Protein'], nutrients: { carbs: 24, protein: 10, fat: 8, fibre: 4, iron: 2.0, calcium: 30, vitC: 0 } },
  { name: 'Muesli (no added sugar)', groups: ['Grains'], nutrients: { carbs: 26, protein: 5, fat: 4, fibre: 5, iron: 2.0, calcium: 30, vitC: 0 } },
  { name: 'Bircher muesli', groups: ['Grains', 'Dairy', 'Fruit'], nutrients: { carbs: 22, protein: 4, fat: 4, fibre: 3, iron: 1.5, calcium: 80, vitC: 3 } },
  ...
  { name: 'Pancakes', groups: ['Grains', 'Dairy'], nutrients: { carbs: 28, protein: 6, fat: 8, fibre: 1, iron: 1.2, calcium: 80, vitC: 0 }, unhealthy: true },
  { name: 'Waffles', groups: ['Grains', 'Dairy'], nutrients: { carbs: 33, protein: 6, fat: 10, fibre: 1, iron: 1.5, calcium: 90, vitC: 0 }, unhealthy: true },
  ...
  { name: 'Pizza', groups: ['Grains', 'Dairy', 'Protein'], nutrients: { carbs: 33, protein: 12, fat: 10, fibre: 2, iron: 1.5, calcium: 150, vitC: 2 }, unhealthy: true },
  { name: 'Chips/fries', groups: ['Grains'], nutrients: { carbs: 30, protein: 3, fat: 15, fibre: 3, iron: 0.6, calcium: 10, vitC: 5 }, unhealthy: true },
  ...
  { name: 'Mac and cheese', groups: ['Grains', 'Dairy'], nutrients: { carbs: 30, protein: 10, fat: 15, fibre: 1, iron: 0.8, calcium: 200, vitC: 0 }, unhealthy: true },
  { name: 'Shepherd\'s pie', groups: ['Protein', 'Vegetables'], nutrients: { carbs: 20, protein: 12, fat: 10, fibre: 3, iron: 1.5, calcium: 30, vitC: 10 } },
  { name: 'Fish and chips', groups: ['Protein', 'Grains'], nutrients: { carbs: 40, protein: 20, fat: 20, fibre: 3, iron: 1.0, calcium: 30, vitC: 5 }, unhealthy: true },
  { name: 'Burger', groups: ['Protein', 'Grains'], nutrients: { carbs: 25, protein: 20, fat: 18, fibre: 2, iron: 2.5, calcium: 40, vitC: 2 }, unhealthy: true },
  { name: 'Hot dog', groups: ['Protein', 'Grains'], nutrients: { carbs: 22, protein: 10, fat: 15, fibre: 1, iron: 1.0, calcium: 20, vitC: 0 }, unhealthy: true },
  ...
  { name: 'Fried rice', groups: ['Grains', 'Vegetables'], nutrients: { carbs: 40, protein: 8, fat: 10, fibre: 2, iron: 1.0, calcium: 20, vitC: 3 }, unhealthy: true },
  ...
  { name: 'Nachos', groups: ['Grains', 'Dairy'], nutrients: { carbs: 30, protein: 8, fat: 18, fibre: 3, iron: 1.0, calcium: 100, vitC: 3 }, unhealthy: true },
  ...
  { name: 'Chicken nuggets', groups: ['Protein', 'Grains'], nutrients: { carbs: 15, protein: 15, fat: 12, fibre: 1, iron: 0.7, calcium: 15, vitC: 0 }, unhealthy: true },
  { name: 'Spring rolls', groups: ['Vegetables', 'Grains'], nutrients: { carbs: 20, protein: 4, fat: 8, fibre: 2, iron: 0.5, calcium: 15, vitC: 3 }, unhealthy: true },
  { name: 'Dumplings', groups: ['Grains', 'Protein'], nutrients: { carbs: 20, protein: 8, fat: 6, fibre: 1, iron: 1.0, calcium: 15, vitC: 0 } },
  { name: 'Samosa', groups: ['Grains', 'Vegetables'], nutrients: { carbs: 25, protein: 4, fat: 12, fibre: 2, iron: 0.8, calcium: 15, vitC: 3 }, unhealthy: true },
  // ── Snacks & treats ──
  { name: 'Granola bar', groups: ['Grains'], nutrients: { carbs: 25, protein: 3, fat: 6, fibre: 2, iron: 1.0, calcium: 20, vitC: 0 } },
  { name: 'Chocolate', groups: [], nutrients: { carbs: 25, protein: 2, fat: 14, fibre: 2, iron: 1.2, calcium: 30, vitC: 0 }, unhealthy: true },
  { name: 'Dark chocolate', groups: [], nutrients: { carbs: 20, protein: 3, fat: 15, fibre: 4, iron: 3.3, calcium: 40, vitC: 0 }, unhealthy: true },
  { name: 'Crisps', groups: [], nutrients: { carbs: 15, protein: 2, fat: 10, fibre: 1, iron: 0.3, calcium: 5, vitC: 3 }, unhealthy: true },
  { name: 'Biscuits', groups: ['Grains'], nutrients: { carbs: 20, protein: 2, fat: 8, fibre: 1, iron: 0.5, calcium: 10, vitC: 0 }, unhealthy: true },
  { name: 'Cake', groups: ['Grains', 'Dairy'], nutrients: { carbs: 35, protein: 4, fat: 15, fibre: 1, iron: 1.0, calcium: 40, vitC: 0 }, unhealthy: true },
  { name: 'Muffin', groups: ['Grains'], nutrients: { carbs: 35, protein: 4, fat: 12, fibre: 1, iron: 1.0, calcium: 30, vitC: 0 }, unhealthy: true },
  { name: 'Flapjack', groups: ['Grains'], nutrients: { carbs: 30, protein: 3, fat: 14, fibre: 2, iron: 1.2, calcium: 20, vitC: 0 }, unhealthy: true },
  { name: 'Brownie', groups: ['Grains'], nutrients: { carbs: 30, protein: 3, fat: 14, fibre: 1, iron: 1.5, calcium: 20, vitC: 0 }, unhealthy: true },
  { name: 'Doughnut', groups: ['Grains'], nutrients: { carbs: 30, protein: 4, fat: 15, fibre: 1, iron: 1.0, calcium: 20, vitC: 0 }, unhealthy: true },
  ...
  { name: 'Jelly/jello', groups: [], nutrients: { carbs: 15, protein: 1, fat: 0, fibre: 0, iron: 0, calcium: 2, vitC: 0 }, unhealthy: true },
  { name: 'Sweets/candy', groups: [], nutrients: { carbs: 25, protein: 0, fat: 0, fibre: 0, iron: 0, calcium: 2, vitC: 0 }, unhealthy: true },
  // ── Drinks ──
  ...
  { name: 'Hot chocolate', groups: ['Dairy'], nutrients: { carbs: 25, protein: 5, fat: 6, fibre: 1, iron: 0.5, calcium: 150, vitC: 0 }, unhealthy: true },
  { name: 'Milkshake', groups: ['Dairy'], nutrients: { carbs: 30, protein: 6, fat: 8, fibre: 0, iron: 0.2, calcium: 200, vitC: 2 }, unhealthy: true },
  // ── Condiments & extras ──
  { name: 'Honey', groups: [], nutrients: { carbs: 17, protein: 0, fat: 0, fibre: 0, iron: 0.1, calcium: 1, vitC: 0 } },
  { name: 'Jam', groups: [], nutrients: { carbs: 15, protein: 0, fat: 0, fibre: 0, iron: 0.1, calcium: 3, vitC: 1 }, unhealthy: true },
  { name: 'Nutella', groups: [], nutrients: { carbs: 12, protein: 1, fat: 6, fibre: 1, iron: 0.5, calcium: 15, vitC: 0 }, unhealthy: true },
  { name: 'Maple syrup', groups: [], nutrients: { carbs: 17, protein: 0, fat: 0, fibre: 0, iron: 0.1, calcium: 13, vitC: 0 }, unhealthy: true },
  ...
  { name: 'Ketchup', groups: [], nutrients: { carbs: 6, protein: 0, fat: 0, fibre: 0, iron: 0.1, calcium: 3, vitC: 1 }, unhealthy: true },
  { name: 'Mayonnaise', groups: [], nutrients: { carbs: 1, protein: 0, fat: 11, fibre: 0, iron: 0, calcium: 2, vitC: 0 }, unhealthy: true },
