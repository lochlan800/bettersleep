...
const FOOD_DATABASE = [
  ...
  { name: 'Weetabix Minis (chocolate)', groups: ['Grains'], nutrients: { carbs: 36, protein: 4, fat: 3, fibre: 3, iron: 4.0, calcium: 20, vitC: 0 } },
  ...
  { name: 'Crunchy Nut Cornflakes', groups: ['Grains'], nutrients: { carbs: 38, protein: 3, fat: 2, fibre: 1, iron: 4.2, calcium: 5, vitC: 0 } },
  { name: 'Cornflakes', groups: ['Grains'], nutrients: { carbs: 36, protein: 3, fat: 0, fibre: 1, iron: 4.0, calcium: 4, vitC: 0 } },
  { name: 'Coco Pops', groups: ['Grains'], nutrients: { carbs: 38, protein: 2, fat: 1, fibre: 1, iron: 4.5, calcium: 10, vitC: 0 } },
  { name: 'Rice Krispies', groups: ['Grains'], nutrients: { carbs: 37, protein: 3, fat: 0, fibre: 0, iron: 4.0, calcium: 4, vitC: 0 } },
  { name: 'Frosties', groups: ['Grains'], nutrients: { carbs: 39, protein: 2, fat: 0, fibre: 1, iron: 4.0, calcium: 3, vitC: 0 } },
  { name: 'Cheerios', groups: ['Grains'], nutrients: { carbs: 32, protein: 4, fat: 2, fibre: 3, iron: 5.0, calcium: 130, vitC: 0 } },
  { name: 'Honey Cheerios', groups: ['Grains'], nutrients: { carbs: 35, protein: 3, fat: 2, fibre: 3, iron: 5.0, calcium: 130, vitC: 0 } },
  { name: 'Shreddies', groups: ['Grains'], nutrients: { carbs: 33, protein: 4, fat: 1, fibre: 5, iron: 4.5, calcium: 20, vitC: 0 } },
  { name: 'Coco Shreddies', groups: ['Grains'], nutrients: { carbs: 35, protein: 3, fat: 2, fibre: 4, iron: 4.5, calcium: 20, vitC: 0 } },
  { name: 'Frosted Shreddies', groups: ['Grains'], nutrients: { carbs: 36, protein: 3, fat: 1, fibre: 4, iron: 4.5, calcium: 20, vitC: 0 } },
  ...
  { name: 'Crunchy Nut Clusters', groups: ['Grains'], nutrients: { carbs: 34, protein: 4, fat: 6, fibre: 2, iron: 3.5, calcium: 10, vitC: 0 } },
  { name: 'Cookie Crisp', groups: ['Grains'], nutrients: { carbs: 38, protein: 2, fat: 3, fibre: 2, iron: 4.0, calcium: 130, vitC: 0 } },
  { name: 'Golden Nuggets', groups: ['Grains'], nutrients: { carbs: 38, protein: 2, fat: 1, fibre: 1, iron: 4.0, calcium: 5, vitC: 0 } },
  { name: 'Sugar Puffs / Honey Monster Puffs', groups: ['Grains'], nutrients: { carbs: 37, protein: 3, fat: 1, fibre: 2, iron: 4.0, calcium: 10, vitC: 0 } },
  { name: 'Raisin Bran', groups: ['Grains', 'Fruit'], nutrients: { carbs: 35, protein: 3, fat: 1, fibre: 5, iron: 5.0, calcium: 20, vitC: 0 } },
  { name: 'Lucky Charms', groups: ['Grains'], nutrients: { carbs: 37, protein: 2, fat: 1, fibre: 1, iron: 4.5, calcium: 130, vitC: 0 } },
  { name: 'Curiously Cinnamon', groups: ['Grains'], nutrients: { carbs: 36, protein: 2, fat: 4, fibre: 2, iron: 4.0, calcium: 130, vitC: 0 } },
  { name: 'Krave', groups: ['Grains'], nutrients: { carbs: 33, protein: 3, fat: 6, fibre: 2, iron: 4.5, calcium: 130, vitC: 0 } },
  { name: 'Lion Cereal', groups: ['Grains'], nutrients: { carbs: 37, protein: 2, fat: 3, fibre: 2, iron: 4.5, calcium: 130, vitC: 0 } },
  { name: 'Nesquik Cereal', groups: ['Grains'], nutrients: { carbs: 37, protein: 2, fat: 2, fibre: 2, iron: 4.5, calcium: 130, vitC: 0 } },
  { name: 'Frosted Flakes', groups: ['Grains'], nutrients: { carbs: 39, protein: 2, fat: 0, fibre: 1, iron: 4.0, calcium: 3, vitC: 0 } },
  ...
  { name: 'Choco Pillows', groups: ['Grains'], nutrients: { carbs: 35, protein: 3, fat: 5, fibre: 2, iron: 4.0, calcium: 15, vitC: 0 } },
  { name: 'Weetos', groups: ['Grains'], nutrients: { carbs: 35, protein: 3, fat: 2, fibre: 3, iron: 4.5, calcium: 20, vitC: 0 } },
  ...
  { name: 'Granola (chocolate)', groups: ['Grains'], nutrients: { carbs: 30, protein: 4, fat: 9, fibre: 3, iron: 1.5, calcium: 25, vitC: 0 } },
